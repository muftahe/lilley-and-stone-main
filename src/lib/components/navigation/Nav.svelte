...
<nav id="navbar">
	...
	<img src = "https://github.com/muftahe/lilyandstone2/blob/master/src/lib/assets/tennis/logo.png" style = "height: 80px; display: block; margin-left: auto; margin-right: auto; margin-top: -2%;" >
